...
public class DefaultNavigationBar2 extends AbsNavigationBar2<DefaultNavigationBar2.Builder.DefaultNavigationParams> {
    public DefaultNavigationBar2(Builder.DefaultNavigationParams mParams) {
        super(mParams);
    }
    ...
    public static class Builder extends AbsNavigationBar2.Builder{
        ...
        @Override
        public DefaultNavigationBar2 builder() {
            DefaultNavigationBar2 navigationBar2 = new DefaultNavigationBar2(P);
        ...
        public static class DefaultNavigationParams extends AbsNavigationBar2.Builder.AbsNavigationParams{
